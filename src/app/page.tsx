      ...
      <div className="container">
        <div className="text-center">
          <h2 className="text-3xl sm:text-5xl font-bold text-foreground mb-6 leading-tight">
            Accelerate your career journey toward dream job with{" "}
            ...
            <div className="bg-card rounded-2xl p-6 border-primary/50 border shadow-lg">
              <div className="bg-muted/50 rounded-lg p-4 mb-4">
                ...
                <div className="bg-background rounded p-2 font-mono text-xs">
                  <span className="text-primary">public int</span>{" "}
                  <span className="text-foreground">twoSum</span>(
                  <span className="text-primary">int[] nums, int target</span>) {"{"}
                  <br />
                  &nbsp;&nbsp;
              ...
              <div className="text-xs text-muted-foreground">
                <span className="text-primary">✓</span> 5/5 test cases passed
              </div>
            </div>
          </div>
        </div>
    ...
    <section className="py-20 bg-muted/30">
      <div className="container">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Don&apos;t just take our word for it. See how JobGenie users
